    ...
    return (
      ...
      <div className='h-full w-full bg-red-800'>
          <div className='flex flex-col items-center justify-center text-center py-20 px-10 '>
              <h1 className='text-6xl text-white font-sans leading-relaxed font-semibold'>Supercharge Your Sales – Smarter, Faster, Stronger Sales <span className='text-blue-500 '>SaleDesk Software</span></h1>
        ...
        <h1 className='text-4xl font-sans font-semibold'>Corefactors <span className='text-blue-500'>Sales Desk?</span></h1>
